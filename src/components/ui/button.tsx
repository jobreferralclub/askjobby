  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:from-primary/90 hover:to-primary/70 elegant-shadow text-base font-semibold transition-bounce transform hover:scale-105",
        professional: "bg-card border border-primary/20 text-foreground hover:bg-primary/5 hover:border-primary/40 card-shadow",
        cta: "bg-primary text-primary-foreground hover:bg-primary/90 animate-glow-pulse text-lg font-bold",
      },
      size: {
