    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 w-full z-50 backdrop-blur-md bg-background/90 border-b border-border">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/pre-sessions" className="text-primary font-semibold">Pre Sessions</Link>
      ...
      <section className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gradient text-center">Pre Sessions</h2>
              ...
              <Card key={item.id} className="overflow-hidden card-gradient card-shadow">
                <a href={item.linkUrl} target="_blank" rel="noopener noreferrer">
                  <div className="relative">
                    <img src={item.imageUrl} alt="Pre Session" className="w-full h-48 object-cover" />
